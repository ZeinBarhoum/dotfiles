# Generated by Powerlevel10k configuration wizard on 2025-04-06 at 05:16 MSK.
...
function prompt_ros_version() {
  local ros_version="${ROS_DISTRO:-}"
  [[ -n $ros_version ]] || return  # Exit if ROS_DISTRO is not set
  p10k segment -f 33 -t "$ros_version"
}
